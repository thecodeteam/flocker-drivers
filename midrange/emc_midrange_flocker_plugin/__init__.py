...
from emc_midrange_flocker_plugin import block_device_api

DRIVER_NAME = u'emc_midrange_flocker_plugin'
...
FLOCKER_BACKEND = node.BackendDescription(
    ...
    required_config={u"ip", u"user", u"password", u"storage_pools"},
